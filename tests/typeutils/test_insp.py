...
class InspTests(unittest.TestCase):
    ...
    def test_get_type_name(self):
        ...
        self.assertEqual('batutils.tpu.structs.empty.Empty', insp.get_any_name(empty.Empty))
        self.assertEqual('batutils.tpu.structs.empty._empty.EmptyDict', insp.get_any_name(empty.EmptyDict))
